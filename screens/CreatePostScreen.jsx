    ...
    <SafeAreaView className="bg-gray-100 h-full">
        <View className="px-4">
            ...
            <>
              ...
              <TouchableOpacity className="flex flex-row justify-center h-48 space-x-2 mt-16 bg-gray-200  items-center rounded-md">
            ...
            <TouchableOpacity
              className="bg-[#eeca70] h-16 w-full items-center mt-20  justify-center rounded-md" 
              onPress={Post}>
